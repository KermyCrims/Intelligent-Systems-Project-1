...
class World:
	def __init__(self, screen):
		...
		self.plan_interval = 2  # frames between proactive replans
	...
	def _ghost_grid_positions(self):
		return [(g.rect.x // CHAR_SIZE, g.rect.y // CHAR_SIZE) for g in self.ghosts.sprites()]
	...
	def _ai_plan_if_needed(self):
		...
		pac.update_ghost_hazards(self._ghost_grid_positions()) # Update ghost hazards (generated by AI (Exequiel)
		...
		if replan:
			...
			self.plan_cooldown = self.plan_interval
